...
--CP
ALTER TABLE dbo.CP ADD CONSTRAINT FK_emp FOREIGN KEY (id_employee) REFERENCES dbo.Employee (id);
GO
ALTER TABLE dbo.CP ADD CONSTRAINT FK_startCity FOREIGN KEY (id_startCity) REFERENCES dbo.City (id);
GO
ALTER TABLE dbo.CP ADD CONSTRAINT FK_endCity FOREIGN KEY (id_endCity) REFERENCES dbo.City (id);
GO
